...
class Critic(object):
  ...
  # def optimize_online_q_net(self,q_loss):
  #     # !!! important: only update online net. dont update target net/ policy net.
  #     # online_q_net_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES,
  #     #                                                scope=DDPG_CFG.online_q_net_var_scope)
  #     train_critic_op = self.optimizer.minimize(loss=q_loss,
  #                                               var_list=self.online_q_net_vars)  ##
  #     return train_critic_op
